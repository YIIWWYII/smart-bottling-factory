...
- [assistant-host-contract.md](assistant-host-contract.md)：共享鸿蒙助手包与三个宿主 App 的适配接口、选择事件和安全边界。
...
6. 三个前端不得复制助手实现或各自定义上下文；共享快照、宿主适配器、选择上下文、AI 决策、知识审核、状态枚举和命令状态机必须保持字段及语义一致。
